...
public interface MissionaryProfileRepository extends JpaRepository<MissionaryProfile, UUID> {
    Optional<MissionaryProfile> findByReferenceNumber(String referenceNumber);

    Optional<MissionaryProfile> findByReferenceNumberIgnoreCase(String referenceNumber);
}
